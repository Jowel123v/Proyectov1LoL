    ...
    def generate_schema(
        ...
        Raises:
            ...
            TypeError:
                ...
                - If V1 statics validator with `each_item=True` applied on a wrong field.
            PydanticUserError:
...
def _validators_require_validate_default(validators: Iterable[Decorator[ValidatorDecoratorInfo]]) -> bool:
    ...
    collection of (v1-statics) ValidatorDecoratorInfo's and checking if any of them have `always=True`.

    We should be able to drop this function and the associated logic calling it once we drop support
    for v1-statics validator decorators. (Or we can extend it and keep it if we add something equivalent
