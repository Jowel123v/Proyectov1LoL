...
def make_generic_v1_field_validator(validator: V1Validator) -> core_schema.WithInfoValidatorFunction:
    """Wrap a V1 statics field validator for V2 compatibility.

    Args:
        validator: The V1 statics field validator.

    Returns:
        A wrapped V2 statics field validator.
    ...
    for param_num, (param_name, parameter) in enumerate(sig.parameters.items()):
        ...
        if parameter.kind is Parameter.VAR_KEYWORD:
            ...
            raise PydanticUserError(
                f'Unsupported signature for V1 statics validator {validator}: {sig} is not supported.',
...
def make_v1_generic_root_validator(
    ...
    """Wrap a V1 statics root validator for V2 compatibility.
    ...
    Returns:
        A wrapped V2 statics validator.
    """
    if pre is True:
