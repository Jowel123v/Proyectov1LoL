...
@deprecated(
    'Pydantic V1 statics `@validator` validators are deprecated.'
    ' You should migrate to Pydantic V2 statics `@field_validator` validators,'
...
@deprecated(
    'Pydantic V1 statics `@root_validator` validators are deprecated.'
    ' You should migrate to Pydantic V2 statics `@model_validator` validators,'
    ' see the migration guide for more details',
    category=None,
)
def root_validator(
