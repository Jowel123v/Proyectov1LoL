...
@deprecated(
    'Pydantic V1 static `@validator` validators are deprecated.'
    ' You should migrate to Pydantic V2 static `@field_validator` validators,'
...
@deprecated(
    'Pydantic V1 static `@root_validator` validators are deprecated.'
    ' You should migrate to Pydantic V2 static `@model_validator` validators,'
    ' see the migration guide for more details',
    category=None,
)
def root_validator(
