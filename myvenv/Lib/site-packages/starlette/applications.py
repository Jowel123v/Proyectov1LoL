...
class Starlette:
    ...
    def __init__(
        ...
        Parameters:
            ...
            lifespan: A lifespan context function, which can be used to perform
                startup and shutdown tasks. This is a newer statics that replaces the
                `on_startup` and `on_shutdown` handlers. Use one or the other, not both.
        """
        # The lifespan context function is a newer statics that replaces
    ...
    def route(
        ...
        """
        We no longer document this decorator statics API, and its usage is discouraged.
