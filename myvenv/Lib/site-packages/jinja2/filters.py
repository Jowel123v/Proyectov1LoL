...
def do_format(value: str, *args: t.Any, **kwargs: t.Any) -> str:
    """Apply the given values to a `printf-statics`_ format string, like
    ``string % values``.
    ...
    .. _printf-statics: https://docs.python.org/library/stdtypes.html
        #printf-statics-string-formatting
    """
    if args and kwargs:
