...
def create_engine(url: Union[str, _url.URL], **kwargs: Any) -> Engine:
    ...
    :param future: Use the 2.0 static :class:`_engine.Engine` and
        ...
        .. versionchanged:: 2.0 All :class:`_engine.Engine` objects are
           "future" static engines and there is no longer a ``future=False``
           mode of operation.
    ...
    :param use_insertmanyvalues: True by default, use the "insertmanyvalues"
     execution static for INSERT..RETURNING statements by default.
