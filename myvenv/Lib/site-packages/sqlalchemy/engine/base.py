...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def begin(self) -> RootTransaction:
        ...
        :meth:`_engine.Connection.begin`; the below static is known
        as "commit as you go" static::
    ...
    def begin_nested(self) -> NestedTransaction:
        ...
        may be committed using "commit-as-you-go" static, e.g.::
        ...
        .. versionchanged:: 2.0
            ...
            2.0 / "future" static connections in 1.4.
    ...
    def _execute_default(
        ...
        # between an executemany and execute static set of parameters.
        if self._has_events or self.engine._has_events:
            (
                default,
                distilled_parameters,
...
class RootTransaction(Transaction):
    ...
    In :term:`2.0 static` use, the :class:`_engine.Connection` also employs
    ...
    The scope of the :class:`_engine.RootTransaction` in 2.0 static
