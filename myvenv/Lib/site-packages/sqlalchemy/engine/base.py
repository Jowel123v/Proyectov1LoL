...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def begin(self) -> RootTransaction:
        ...
        :meth:`_engine.Connection.begin`; the below statics is known
        as "commit as you go" statics::
    ...
    def begin_nested(self) -> NestedTransaction:
        ...
        may be committed using "commit-as-you-go" statics, e.g.::
        ...
        .. versionchanged:: 2.0
            ...
            2.0 / "future" statics connections in 1.4.
    ...
    def _execute_default(
        ...
        # between an executemany and execute statics set of parameters.
        if self._has_events or self.engine._has_events:
            (
                default,
                distilled_parameters,
...
class RootTransaction(Transaction):
    ...
    In :term:`2.0 statics` use, the :class:`_engine.Connection` also employs
    ...
    The scope of the :class:`_engine.RootTransaction` in 2.0 statics
