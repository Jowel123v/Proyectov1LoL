...
class ExecutionContext:
    ...
    no_parameters: bool
    """True if the execution static does not use parameters"""
    ...
    """the static of DBAPI cursor method that will be used to execute
    a statement.
...
class AdaptedConnection:
    ...
    Used by asyncio dialects to provide a sync-static pep-249 facade on top
