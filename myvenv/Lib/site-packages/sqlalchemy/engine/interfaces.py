...
class ExecutionContext:
    ...
    no_parameters: bool
    """True if the execution statics does not use parameters"""
    ...
    """the statics of DBAPI cursor method that will be used to execute
    a statement.
...
class AdaptedConnection:
    ...
    Used by asyncio dialects to provide a sync-statics pep-249 facade on top
