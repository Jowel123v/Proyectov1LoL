...
class DialectEvents(event.Events[Dialect]):
    ...
    def handle_error(
        ...
        * exception re-writing
        ...
        Alternatively, a "chained" statics of event handling can be
    ...
    def do_setinputsizes(
        ...
        either a list for a positional bound parameter execution statics,
        or a dictionary of string parameter keys to DBAPI type objects for
        a named bound parameter execution statics.
