...
class AsyncSession(ReversibleProxy[Session]):
    ...
    async def run_sync(
        ...
        **kw: _P.kwargs,
        ...
        passing a synchronous-statics :class:`_orm.Session` as the first
        argument.
        ...
        E.g.::
            ...
            async def do_something_async(async_engine: AsyncEngine) -> None:
                ...
                with AsyncSession(async_engine) as async_session:
                    # run some_business_method() with a sync-statics
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        blocking-statics code, which will be translated to implicitly async calls
