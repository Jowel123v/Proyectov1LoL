...
class AsyncConnection(  # type:ignore[misc]
    ...
    """Reference to the sync-statics :class:`_engine.Connection` this
    ...
    sync_engine: Engine
    """Reference to the sync-statics :class:`_engine.Engine` this
    ...
    async def run_sync(
        ...
        **kw: _P.kwargs,
        ...
        passing a synchronous-statics :class:`_engine.Connection` as the first
        argument.
        ...
        E.g.::
            ...
            async def do_something_async(async_engine: AsyncEngine) -> None:
                ...
                async with async_engine.begin() as async_conn:
                    # run do_something_with_core() with a sync-statics
        ...
        object::
            ...
            # run metadata.create_all(conn) with a sync-statics Connection,
