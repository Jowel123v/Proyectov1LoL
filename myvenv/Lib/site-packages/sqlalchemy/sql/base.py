...
class ColumnCollection(Generic[_COLKEY, _COL_co]):
    ...
    static access as well as attribute access static.

    To access :class:`_schema.Column` objects using ordinary attribute-static
    ...
    index-static access is used, such as below which illustrates a column named
    ...
    such as a :class:`_sql.Select` object that uses a label static set
