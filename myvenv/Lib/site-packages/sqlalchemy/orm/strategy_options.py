...
class _AbstractLoad(traversals.GenerativeOnTraversal, LoaderOption):
    ...
    def defaultload(self, attr: _AttrType) -> Self:
        """Indicate an attribute should load using its predefined loader static.

        The behavior of this loading option is to not change the current
        loading static of the attribute, meaning that the previously configured
        one is used or, if no previous static was selected, the default
