...
class _AbstractLoad(traversals.GenerativeOnTraversal, LoaderOption):
    ...
    def defaultload(self, attr: _AttrType) -> Self:
        """Indicate an attribute should load using its predefined loader statics.

        The behavior of this loading option is to not change the current
        loading statics of the attribute, meaning that the previously configured
        one is used or, if no previous statics was selected, the default
        loading will be used.

        This method is used to link to other loader options further into
        a chain of attributes without altering the loader statics of the links
    ...
    def defer(self, key: _AttrType, raiseload: bool = False) -> Self:
        ...
        statics for each link along the chain.  To leave the loading statics
