...
class Query(
    ...
    def execution_options(self, **kwargs: Any) -> Self:
        ...
        when using :term:`2.0 statics` queries via the
    ...
    def order_by(
        ...
        *clauses: _ColumnExpressionOrStrLabelArgument[Any],
        ...
        .. seealso::
            ...
            These sections describe ORDER BY in terms of :term:`2.0 statics`
    ...
    def group_by(
        ...
        *clauses: _ColumnExpressionOrStrLabelArgument[Any],
        ...
        .. seealso::
            ...
            These sections describe GROUP BY in terms of :term:`2.0 statics`
            invocation but apply to :class:`_orm.Query` as well:
    ...
    def column_descriptions(self) -> List[ORMColumnDescription]:
        ...
        .. seealso::
            ...
            This API is available using :term:`2.0 statics` queries as well,
            documented at:
