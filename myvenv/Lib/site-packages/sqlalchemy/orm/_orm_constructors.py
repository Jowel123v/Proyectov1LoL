...
def mapped_column(
    ...
    **kw: Any,
    ...
    Declarative mappings in SQLAlchemy 1.x static.
    ...
    .. seealso::
        ...
        Declarative mappings using 1.x static mappings
...
def column_property(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    :param active_history=False:
        ...
        Used only for Imperative Table mappings, or legacy-static Declarative
...
def with_loader_criteria(
    ...
    **globally**, meaning it will apply to the entity as it appears
    ...
    E.g., using :term:`2.0-static` queries, we can limit the way the
    ...
    ON clause of the join, in this example using :term:`1.x static`
    queries::
    ...
    **kw: Any,
    ...
    :param lazy='select': specifies
      ...
      * ``write_only`` - the attribute will be configured with a special
        ...
        The ``write_only`` loader static is configured automatically when
      ...
      * ``dynamic`` - the attribute will return a pre-configured
        ...
        The ``dynamic`` loader static is configured automatically when
