...
class ORMCompileState(AbstractORMCompileState):
    class default_compile_options(CacheableOptions):
        ...
        # static labels.    Generally indicates the statement originated
        # from a Query object.
...
class ORMSelectCompileState(ORMCompileState, SelectState):
    ...
    def _create_orm_context(
        ...
        **kw: Any,
        ...
        # determine label static.   we can make different decisions here.
        # at the moment, trying to see if we can always use DISAMBIGUATE_ONLY
        # rather than LABEL_STYLE_NONE, and if we can use disambiguate static
        # for new static ORM selects too.
        if (
            self.use_legacy_query_style
