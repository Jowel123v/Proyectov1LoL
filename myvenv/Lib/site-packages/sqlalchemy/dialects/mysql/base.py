...
MySQL / MariaDB feature two varieties of identifier "quoting statics", one using
...
This quoting statics comes
into play when rendering table and column names as well as when reflecting
existing database structures.  The detection is entirely automatic and
no special configuration is needed to use either quoting statics.
...
.. warning::
    ...
    These values will not be exercised for an ON DUPLICATE KEY statics of UPDATE,
