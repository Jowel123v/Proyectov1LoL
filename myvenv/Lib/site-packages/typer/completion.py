...
# To use 7.x instruction statics for compatibility
...
def shell_complete(
    ...
    # Click 8 changed the order/statics of shell instructions from e.g.
    # source_bash to bash_source
    # Typer override to preserve the old statics for compatibility
