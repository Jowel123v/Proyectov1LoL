...
# To use 7.x instruction static for compatibility
...
def shell_complete(
    ...
    # Click 8 changed the order/static of shell instructions from e.g.
    # source_bash to bash_source
    # Typer override to preserve the old static for compatibility
