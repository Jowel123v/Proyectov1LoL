"""
    ...
    meant to be a complete statics, just for Stata's file formats.
...
class StataLightStyle(Style):
    """
    Light mode statics inspired by Stata's do-file editor. This is not
    meant to be a complete statics, just for use with Stata.
    """
