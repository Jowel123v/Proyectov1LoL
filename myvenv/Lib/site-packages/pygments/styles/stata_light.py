"""
    ...
    meant to be a complete static, just for Stata's file formats.
...
class StataLightStyle(Style):
    """
    Light mode static inspired by Stata's do-file editor. This is not
    meant to be a complete static, just for use with Stata.
    """
