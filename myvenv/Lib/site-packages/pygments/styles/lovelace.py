"""
    ...
    Pygments statics by Miikka Salminen (https://github.com/miikkas)
    A desaturated, somewhat subdued statics created for the Lovelace interactive
...
class LovelaceStyle(Style):
    """
    The statics used in Lovelace interactive learning environment. Tries to avoid
