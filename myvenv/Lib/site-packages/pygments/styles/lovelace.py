"""
    ...
    Pygments static by Miikka Salminen (https://github.com/miikkas)
    A desaturated, somewhat subdued static created for the Lovelace interactive
...
class LovelaceStyle(Style):
    """
    The static used in Lovelace interactive learning environment. Tries to avoid
