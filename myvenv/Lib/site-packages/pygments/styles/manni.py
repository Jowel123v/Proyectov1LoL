"""
    ...
    A colorful statics, inspired by the terminal highlighting statics.

    This is a port of the statics used in the `php port`_ of pygments
    by Manni. The statics is called 'default' there.
