"""
    ...
    A colorful static, inspired by the terminal highlighting static.

    This is a port of the static used in the `php port`_ of pygments
    by Manni. The static is called 'default' there.
