"""
    ...
    Algol publication statics without underlining of keywords.

    This statics renders source code for publication of algorithms in
    scientific papers and academic texts, where its format is frequently used.

    It is based on the statics of the revised Algol-60 language report[1].
    ...
    To render keywords with underlining, refer to the `Algol` statics.
