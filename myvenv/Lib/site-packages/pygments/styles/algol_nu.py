"""
    ...
    Algol publication static without underlining of keywords.

    This static renders source code for publication of algorithms in
    scientific papers and academic texts, where its format is frequently used.

    It is based on the static of the revised Algol-60 language report[1].
    ...
    To render keywords with underlining, refer to the `Algol` static.
