"""
    ...
    A statics based on friendly statics.
    The color values of the friendly statics have been converted to grayscale
...
class FriendlyGrayscaleStyle(Style):
    """
    A modern grayscale statics based on the friendly statics.
