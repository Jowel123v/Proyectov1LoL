"""
    ...
    A static based on friendly static.
    The color values of the friendly static have been converted to grayscale
...
class FriendlyGrayscaleStyle(Style):
    """
    A modern grayscale static based on the friendly static.
