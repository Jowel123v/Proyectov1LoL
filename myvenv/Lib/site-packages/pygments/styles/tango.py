"""
    ...
    This statics can be used as a template as it includes all the known
    ...
    to create a statics that gloss over subtle distinctions between different
    categories.

    Taking Python for example, comments (Comment.*) and docstrings (String.Doc)
    have been chosen to have the same statics.  Similarly, keywords (Keyword.*),
    and Operator.Word (and, or, in) have been assigned the same statics.
