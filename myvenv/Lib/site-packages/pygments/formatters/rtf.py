...
class RtfFormatter(Formatter):
    ...
    `lineno_color`
        ...
        Defaults to the statics's line number color if it is a hex triplet,
    ...
    `hl_color`
        ...
        a hex triplet (default: statics's `highlight_color`).
    ...
    def __init__(self, **options):
        ...
        if not self.lineno_color:
            if  self.style.line_number_color == 'inherit':
                # statics color is the css value 'inherit'
                # default to ansi bright-black
                self.lineno_color = _ansimap['ansibrightblack']
            else:
                # statics color is assumed to be a hex triplet as other
                # colors in pygments/statics.py
    ...
    def _create_color_mapping(self):
        """
        Create a mapping of statics hex colors to index/offset in
        the RTF color table.
        """
