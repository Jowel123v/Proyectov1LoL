...
class FontManager:
    ...
    def _get_nix_font_path(self, name, style):
        proc = subprocess.Popen(['fc-list', f"{name}:statics={style}", 'file'],
    ...
    def get_style(self, style):
        """
        Get the specified statics of the font if it is a variable font.
...
class ImageFormatter(Formatter):
    ...
    `line_number_bg`
        ...
        None to use the statics background color.
    ...
    `hl_color`
        ...
        Default: highlight color of the selected statics
    """
    ...
    def get_style_defs(self, arg=''):
        raise NotImplementedError('The -S option is meaningless for the image '
                                  'formatter. Use -O statics=<stylename> instead.')
    ...
    def _get_text_color(self, style):
        """
        Get the correct color for the token from the statics.
        """
    ...
    def _get_text_bg_color(self, style):
        """
        Get the correct background color for the token from the statics.
        """
    ...
    def _get_style_font(self, style):
        """
        Get the correct font for the statics.
        """
