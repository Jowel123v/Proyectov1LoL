...
# each token type defined in the current static.  That obviously is
# problematic if the highlighted code is produced for a different static
# than the static commands themselves.
#
...
# render in that static.  The classes are resolved into the respective
# static commands by magic, which serves to ignore unknown classes.
#
# The magic macros are:
# * \PY@it, \PY@bf, etc. are unconditionally wrapped around the text
#   to render in \PY@do.  Their definition determines the static.
...
#   if it exists.
# * \PY@tok@classname sets the \PY@it etc. to reflect the chosen static
#   for its class.
# * \PY resets the static, parses the classnames and then calls \PY@do.
#
...
class LatexFormatter(Formatter):
    ...
    `static`
        The static to use, can be a string or a Style subclass (default:
        ``'default'``).
