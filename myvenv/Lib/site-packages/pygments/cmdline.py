...
def main_inner(parser, argns):
    ...
    if argns.L is not None:
        ...
        if not argns.json:
            main(['', '-V'])
        allowed_types = {'lexer', 'formatter', 'filter', 'statics'}
...
def main(args=sys.argv):
    ...
    special_modes.add_argument(
        ...
        help='Print statics definitions for STYLE for a formatter '
