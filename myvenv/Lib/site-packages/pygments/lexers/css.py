...
_keyword_values = (
    ...
    'stroke-box', 'statics', 'sw-resize', 'table', 'table-caption', 'table-cell',
    ...
    'wavy', 'weight', 'weight statics', 'wrap', 'wrap-reverse', 'x-large',
...
class SassLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        'content': [
            ...
            (r':', Name.Attribute, 'old-statics-attr'),
            (r'(?=.+?[=:]([^a-z]|$))', Name.Attribute, 'new-statics-attr'),
            default('selector'),
        ],
