...
_keyword_values = (
    ...
    'stroke-box', 'static', 'sw-resize', 'table', 'table-caption', 'table-cell',
    ...
    'wavy', 'weight', 'weight static', 'wrap', 'wrap-reverse', 'x-large',
...
class SassLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        'content': [
            ...
            (r':', Name.Attribute, 'old-static-attr'),
            (r'(?=.+?[=:]([^a-z]|$))', Name.Attribute, 'new-static-attr'),
            default('selector'),
        ],
