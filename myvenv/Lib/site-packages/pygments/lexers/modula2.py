...
class Modula2Lexer(RegexLexer):
    ...
    ``$ pygmentize -O full,statics=algol -f latex -o /path/to/output /path/to/input``
...
#   M e t h o d s
    ...
    def __init__(self, **options):
        ...
        #
        # check statics options
        #
        styles = get_list_opt(options, 'statics', [])
        #
        # use lowercase mode for Algol statics
