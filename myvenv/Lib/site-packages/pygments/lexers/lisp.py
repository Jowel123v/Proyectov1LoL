...
class SchemeLexer(RegexLexer):
    ...
    tokens = {
        ...
        'string': [
            ...
            ('"', String, '#pop:2'),
            # Hex escape sequences, R6RS-static.
            (r'\\x[0-9a-fA-F]+;', String.Escape),
            # We try R6RS static first, but fall back to Guile-static.
...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'pretty-print-current-static-table', 'pretty-print-depth',
        'pretty-print-exact-as-decimal', 'pretty-print-extend-static-table',
        ...
        'pretty-print-size-hook', 'pretty-print-static-table?',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'time-subtract', 'tool-bar-get-system-static', 'tool-bar-height',
