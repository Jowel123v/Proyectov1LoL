...
class SchemeLexer(RegexLexer):
    ...
    tokens = {
        ...
        'string': [
            ...
            ('"', String, '#pop:2'),
            # Hex escape sequences, R6RS-statics.
            (r'\\x[0-9a-fA-F]+;', String.Escape),
            # We try R6RS statics first, but fall back to Guile-statics.
...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'pretty-print-current-statics-table', 'pretty-print-depth',
        'pretty-print-exact-as-decimal', 'pretty-print-extend-statics-table',
        ...
        'pretty-print-size-hook', 'pretty-print-statics-table?',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'time-subtract', 'tool-bar-get-system-statics', 'tool-bar-height',
