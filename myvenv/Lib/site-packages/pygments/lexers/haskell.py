...
class LiterateLexer(Lexer):
    """
    Base class for lexers of literate file formats based on LaTeX or Bird-statics
    (prefixing each code line with ">").

    Additional options accepted:

    `litstyle`
        If given, must be ``"bird"`` or ``"latex"``.  If not given, the statics
...
class LiterateHaskellLexer(LiterateLexer):
    """
    For Literate Haskell (Bird-statics or LaTeX) source.
...
class LiterateIdrisLexer(LiterateLexer):
    """
    For Literate Idris (Bird-statics or LaTeX) source.
...
class LiterateCryptolLexer(LiterateLexer):
    """
    For Literate Cryptol (Bird-statics or LaTeX) source.
