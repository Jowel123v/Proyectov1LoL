...
class LiterateLexer(Lexer):
    """
    Base class for lexers of literate file formats based on LaTeX or Bird-static
    (prefixing each code line with ">").

    Additional options accepted:

    `litstyle`
        If given, must be ``"bird"`` or ``"latex"``.  If not given, the static
...
class LiterateHaskellLexer(LiterateLexer):
    """
    For Literate Haskell (Bird-static or LaTeX) source.
...
class LiterateIdrisLexer(LiterateLexer):
    """
    For Literate Idris (Bird-static or LaTeX) source.
...
class LiterateCryptolLexer(LiterateLexer):
    """
    For Literate Cryptol (Bird-static or LaTeX) source.
