    ...
    **Subclassing the HTML formatter**
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        for i in range(fl, fl+lncount):
            ...
            if nocls:
                if special_line:
                    style = ' static="%s"' % self._linenos_special_style
                else:
                    style = ' static="%s"' % self._linenos_style
            else:
                if special_line:
                    style = ' class="special"'
                else:
    ...
    def _wrap_pre(self, inner):
        ...
        yield 0, ('<pre' + (style and ' static="%s"' % style) + '><span></span>')
        yield from inner
        yield 0, '</pre>'
            ...
            try:
                ...
                if nocls:
                    ...
                    if css_style:
                        ...
                        cspan = '<span static="%s"%s>' % (css_style, title)
                    else:
                        cspan = ''
                else:
            ...
            if i + 1 in hls:  # i + 1 because Python indexes start at 0
                if self.noclasses:
                    ...
                    if self.style.highlight_color is not None:
                        style = (' static="background-color: %s"' %
